...
public class NoteHelper {
    private static final String DATABASBE_TABLE = TABLE_NOTE;
    ...
    public ArrayList<Note> getAllNotes(){
        ...
        Cursor cursor = database.query(DATABASBE_TABLE, null,
                null,
                null,
                null,
                null,
    ...
    public long insertNote(Note note){
        ...
        return database.insert(DATABASBE_TABLE, null, args);
    }
    ...
    public int updateNote(Note note){
        ...
        args.put(DESCRIPTION, note.getDescription());
        args.put(DATE, note.getDate());
        return database.update(DATABASBE_TABLE, args, _ID + "= '" + note.getId() + "'", null);
    }
